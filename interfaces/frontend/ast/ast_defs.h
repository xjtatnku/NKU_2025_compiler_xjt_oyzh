...
#undef X
    ...
    struct VarValue
    {
        ...
        bool getBool() const
        {
            ...
            if (type == voidType) return false;  // treat uninitialized as false
            // For any other unexpected type (e.g., pointer), gracefully treat as false
            return false;
        }
        int getInt() const
        {
            ...
            if (type == voidType) return 0;  // treat uninitialized as 0
            // For any other unexpected type (e.g., pointer), gracefully treat as 0
            return 0;
        }
        long long getLL() const
        {
            ...
            if (type == voidType) return 0;  // treat uninitialized as 0
            // For any other unexpected type, gracefully treat as 0
            return 0;
        }
        float getFloat() const
        {
            ...
            if (type == voidType) return 0.0f;  // treat uninitialized as 0.0
            // For any other unexpected type, gracefully treat as 0.0
            return 0.0f;
        }
    };
